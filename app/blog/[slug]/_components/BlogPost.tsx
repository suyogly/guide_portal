                            ...
                            <div className="mt-20 pt-12 border-t border-white/10 flex flex-col md:flex-row gap-8 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 leading-relaxed mb-6">
                                        An experienced mountain guide and contributor to TrekGuide Hub, sharing expertise from years on Nepal&apos;s trails.
                                    </p>
                                    <Link href="/blog" className="text-nepal-orange font-bold hover:underline">
                                        View More Articles →
                                    </Link>
                                </div>
                            </div>
